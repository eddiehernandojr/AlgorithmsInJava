/**
 *  Greedy Algorithm 3 (version 2):
 *  Minimum Number of Coins (version 2)
 *
...
public class MinimumNumberOfCoins2 {
    public static int[] denom = { 1000, 500, 100, 50, 20, 1, 2, 5, 10 };
    public static int n = denom.length;
    ...
    public static void findMin(int amount) {
        ...
        // Note:
        // Make sure the denomination is sorted in descending order
        // before proceeding with the logic.
        // To achieve this, sort the array in ascending order then
